...
const MoneyCommandAILogo = () => (
  <svg width="22" height="22" viewBox="0 0 48 46" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ color: '#ffffff' }}>
            ...
            <div className="moneycommandai-chat-header">
              ...
              <div className="moneycommandai-chat-header__brand">
                <div className="moneycommandai-chat-header__logo">
                  <img
                    src="https://ik.imagekit.io/kabi10/MoneyCommandAI_Chatbot_Avatar.png"
